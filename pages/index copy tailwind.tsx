...
export default function Home() {
  return (
    <div className="bg-slate-400 py-20 px-20 grid gap-10 lg:grid-cols-2 xl:grid-cols-3 min-h-screen">
      ...
      <div className="bg-white p-10 rounded-2xl shadow-xl lg:col-span-2">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex justify-between items-center">
            ...
            <button className="bg-blue-500 py-2 px-8 text-xs text-white rounded-lg">Add to cart</button>
          </div>
        </div>
