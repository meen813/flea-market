...
export default function Welcome() {
    ...
    return (
        <div className="mt-16 px-4">
            <h3 className="text-3xl font-bold text-center">Welcome to Ian's Marketplace</h3>
            <div className="mt-8">
                ...
                <form className="flex flex-col mt-8">
                    ...
                    <div className="mt-1">
                        {method === "email" ? <input id="input" type="email" className="appearance-none w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:ring-orange-500 focus:border-orange-500" required /> : null}
                        {method === "phone" ? (
                            <div className="flex rounded-md shadow-sm">
                                <span className="flex items-center justify-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-gray-500 select-none text-sm ">+1</span>
                                <input id="input" type="number" className="py-2 px-4 border border-gray-300 rounded-md rounded-l-none shadow-sm placeholder-gray-400 focus:ring-orange-500 focus:border-orange-500" required />
                            </div>
                        ) : null}
                    </div>
                ...
                <div className="mt-8">
                    <div className="relative">
                        ...
                        <div className="relative -top-3 text-center">
                            <span className="bg-white px-2 text-xm text-gray-500">Or enter with</span>
                        </div>
                    </div>
